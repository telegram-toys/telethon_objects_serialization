...
def patch_telethon_classes() -> None:
    ...
    logger.info(
        ...
        total_patched,
        alltlobjects_patched_count,
        non_alltlobjects_patched_count,
    )
...
def restore_instance(raw: Any) -> Any:
    ...
    if isinstance(raw, dict):
        ...
        return obj_class(**restored_dict)
...
def object_hook_json_helper(obj: dict[Any, Any]) -> Any:
...
def tl_obj_to_string(obj: TLObject, ensure_ascii: bool = True, indent: int | None = None) -> str:
    _check_patch_was_applied()
    obj_dict = obj.to_dict()
    return json.dumps(obj_dict, ensure_ascii=ensure_ascii, indent=indent, default=default_json_helper)
...
TEST_MESSAGE: Final = patched.Message(
    id=1001,
    peer_id=telethon.tl.types.PeerChannel(channel_id=1002),
    date=datetime.datetime(2025, 12, 1, 1, 2, 3, tzinfo=datetime.UTC),
    message='message',
    out=False,
    mentioned=False,
    media_unread=False,
    ...
    fwd_from=telethon.tl.types.MessageFwdHeader(
        date=datetime.datetime(2025, 12, 1, 0, 1, 2, tzinfo=datetime.UTC),
        imported=False,
        saved_out=False,
        from_id=telethon.tl.types.PeerChannel(channel_id=1003),
        from_name=None,
        channel_post=1004,
        post_author=None,
    ...
    media=telethon.tl.types.MessageMediaPhoto(
        ...
        photo=telethon.tl.types.Photo(
            ...
            date=datetime.datetime(2025, 12, 1, 1, 2, 3, tzinfo=datetime.UTC),
            sizes=[
                telethon.tl.types.PhotoStrippedSize(type='i', bytes=b'\x01\x15(b8\x89'),
                telethon.tl.types.PhotoSize(type='m', w=320, h=100, size=1000),
                telethon.tl.types.PhotoSize(type='x', w=800, h=400, size=2000),
    ...
    entities=[
        ...
        telethon.tl.types.MessageEntityTextUrl(offset=1, length=9, url='URL'),
        telethon.tl.types.MessageEntityMention(offset=5, length=2),
    ],
    views=100,
    forwards=10,
    replies=None,
    edit_date=datetime.datetime(2025, 12, 1, 1, 2, 4, tzinfo=datetime.UTC),
    post_author=None,
    grouped_id=None,
    reactions=telethon.tl.types.MessageReactions(
        results=[
            telethon.tl.types.ReactionCount(
                reaction=telethon.tl.types.ReactionEmoji(emoticon='🤔'), count=1, chosen_order=None
            ),
            telethon.tl.types.ReactionCount(
                reaction=telethon.tl.types.ReactionEmoji(emoticon='❤'), count=2, chosen_order=None
            ),
            telethon.tl.types.ReactionCount(
                reaction=telethon.tl.types.ReactionEmoji(emoticon='👍'), count=3, chosen_order=None
            ),
            telethon.tl.types.ReactionCount(
                reaction=telethon.tl.types.ReactionEmoji(emoticon='😢'), count=4, chosen_order=None
            ),
            telethon.tl.types.ReactionCount(
                reaction=telethon.tl.types.ReactionEmoji(emoticon='👎'), count=5, chosen_order=None
            ),
            telethon.tl.types.ReactionCount(
                reaction=telethon.tl.types.ReactionEmoji(emoticon='🔥'), count=6, chosen_order=None
            ),
            telethon.tl.types.ReactionCount(
                reaction=telethon.tl.types.ReactionEmoji(emoticon='🤬'), count=7, chosen_order=None
            ),
        ],
        min=False,
        can_see_list=False,
...
def main() -> None:
    ...
    check_telethon_obj_serialization(TEST_MESSAGE)
